<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      <template #header>
        <el-button v-permission="['scm:supplier:add']" type="success" @click="handleAdd"
          ><i-ep-plus />新增</el-button
        >
        <el-button
          v-permission="['scm:supplier:edit']"
          type="warning"
          :disabled="single"
      ...
      >
        ...
        <el-table-column label="所在省份" prop="province" align="center" />
...
import { listSupplier, delSupplier } from "@/api/scm/supplier";
import { SupplierQuery, SupplierVO } from "@/api/scm/supplier/types";
...
const list = ref<SupplierVO[]>([]); // 分页数据
